...
val_left = float(config.get('MouseControl', 'val_left'))
val_right = float(config.get('MouseControl', 'val_right'))
val_left_area = int(config.get('MouseControl', 'val_left_area'))
val_right_area = int(config.get('MouseControl', 'val_right_area'))
val_scrolling = float(config.get('MouseControl', 'val_scrolling'))
